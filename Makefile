...
util/responsive-image :
	$(MAKE) util/image-processing image-processing_cmd="{toxinidir}/util/process-image.py compress --format jpg --format png --source ./_imp/source/foo.jpg --destination ./_imp/out"
